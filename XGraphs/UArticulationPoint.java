...
public class UArticulationPoint {
  private int time = 0;

  public void findArticulationPoints(List<List<Integer>> adj, int V) {
  ...
  public static void main(String[] args) {
    ...
    UArticulationPoint obj = new UArticulationPoint();
    obj.findArticulationPoints(adj, V);
  }
}